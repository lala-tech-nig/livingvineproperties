    ...
    return (
        <div className="flex min-h-screen bg-gray-50 flex-col md:flex-row">
            <div className="hidden md:flex w-1/2 bg-orange-950 relative overflow-hidden items-center justify-center">
                <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1560518883-ce09059eeffa?q=80&w=2573&auto=format&fit=crop')] bg-cover bg-center mix-blend-overlay opacity-30"></div>
            ...
            <div className="w-full md:w-1/2 flex items-center justify-center p-6 sm:p-12 md:p-16 bg-white relative overflow-y-auto">
                ...
                >
                    <div className="mb-8 text-center md:text-left">
                        ...
                        <h2 className="text-3xl font-bold text-gray-900 mb-2 font-serif">Create an account</h2>
                    ...
                    <p className="mt-8 text-center text-gray-600 text-sm">
                        ...
                        <Link href="/investor/login" className="font-semibold text-[#de1f25] hover:text-[#de1f25]">
                            Sign in here
                        </Link>
                    </p>
                </motion.div>
