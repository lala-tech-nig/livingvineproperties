    ...
    return (
        <div className="p-4 md:p-8 max-w-4xl mx-auto pb-20">
            <header className="mb-8">
                ...
                <p className="text-gray-400 mt-2">Live stream of tasks and investor activities requiring attention.</p>
            </header>

            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm divide-y divide-gray-100 text-gray-900">
