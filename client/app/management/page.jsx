...
import { Briefcase, AlertCircle, Eye } from 'lucide-react';
    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-gray-400">Monitor all initial investments and relay to CEO.</p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-2xl border border-yellow-200 shadow-sm shadow-yellow-100/10 text-gray-900">
