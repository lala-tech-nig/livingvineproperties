...
export default function SuperAdminDashboard() {
    ...
    return (
        <div className="space-y-8">
                ...
                {stats.map((stat, index) => (
                    ...
                    >
                        <div className="flex flex-col gap-4">
                            <div className={`${stat.color} w-12 h-12 rounded-xl text-white flex items-center justify-center shadow-lg shadow-indigo-100/10`}>
                                <stat.icon size={24} />
                            </div>
                            <div>
            ...
            <div className="bg-slate-900 text-white p-8 rounded-3xl overflow-hidden relative border border-slate-800">
