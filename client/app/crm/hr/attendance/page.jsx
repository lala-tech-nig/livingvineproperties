    ...
    return (
        <div className="space-y-8">
            <header>
                ...
                <p className="text-gray-400">Log your daily work hours and track your attendance history.</p>
            </header>
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 text-gray-900">
                <h3 className="font-semibold mb-4 flex items-center gap-2 text-gray-900"><Clock size={18} /> Recent History</h3>
