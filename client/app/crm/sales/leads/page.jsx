        ...
        <div className="space-y-8">
            <header className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-gray-400">Track and nurture potential customers in your pipeline.</p>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden text-gray-900">
                <div className="p-4 border-b border-gray-100">
                    <div className="relative">
                        ...
                        <input type="text" placeholder="Search leads..." className="w-full pl-10 pr-4 py-2 bg-gray-50 border-none rounded-xl text-sm text-gray-900" />
                    </div>
                </div>
