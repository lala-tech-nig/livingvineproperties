...
export default function CEODashboard() {
    ...
    if (loading) return <div className="p-10 text-center text-white">Loading CEO terminal...</div>;

    return (
        <div className="space-y-6">
            <div>
                <h2 className="text-2xl font-bold text-white">CEO Executive Terminal</h2>
                <p className="text-gray-400">Global overview and absolute control over portfolios.</p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm relative overflow-hidden">
                    <div className="flex items-center gap-3 mb-2 text-gray-500">
                        ...
                        <h3 className="font-medium text-gray-700">Total Portfolios</h3>
                    </div>
