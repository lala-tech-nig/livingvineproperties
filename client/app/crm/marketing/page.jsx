    ...
    return (
        <div className="space-y-8">
            <header>
                ...
                <p className="text-gray-400">Manage your leads and automated customer engagement.</p>
            </header>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 text-center text-gray-900">
                <Megaphone size={64} className="mx-auto mb-4 text-gray-200" />
                <h3 className="text-xl font-semibold mb-2 text-gray-900">No active campaigns</h3>
